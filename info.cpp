...
void Info::initInfo()
{
    ...
    m_txtScoreJ1.setPosition((largeurF/2)-100,30);
    m_txtScoreJ1.setFillColor(sf::Color::White);


    m_txtScoreJ2.setFont(m_font1);
    m_txtScoreJ2.setCharacterSize(30);
    m_txtScoreJ2.setPosition((largeurF/2)+100,30);
    m_txtScoreJ2.setFillColor(sf::Color::White);
